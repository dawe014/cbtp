...
$query=mysqli_query($mysqli,"insert into his_patients(pat_fname,pat_lname,pat_number,pat_addr,his_citiy,pat_gender,pat_email,pat_pass) values('$fname','$lname','$pat_number','$address','$city','$gender','$email','$password')");
if($query)
{
