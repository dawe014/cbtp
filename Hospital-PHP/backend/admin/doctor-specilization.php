...
$sql=mysqli_query($mysqli,"insert into doctorspecilization(specilization) values('$doctorspecilization')");
$_SESSION['msg']="Doctor Specialization added successfully !!";
// echo "Doctor Specialization added successfully !!";
}
//Code Deletion
if(isset($_GET['del']))
{
$sid=$_GET['id'];	
mysqli_query($mysqli,"delete from doctorSpecilization where id = '$sid'");
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Doctor Specialization">
								...
								<div class="col-md-12">
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($mysqli,"select * from doctorSpecilization");
$cnt=1;
