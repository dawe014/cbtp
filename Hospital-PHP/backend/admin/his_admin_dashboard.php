                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <a href="his_admin_view_out_patients.php" style="text-decoration: none;">
                            ...
                            <!--Start InPatients-->
                            <div class="col-md-6 col-xl-4">
                            <a href="his_admin_view_in_patients.php" style="text-decoration: none;">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-primary border-primary border">
                            ...
                            <!--Start Employees-->
                            <div class="col-md-6 col-xl-4">
                            <a href="his_admin_view_employee.php" style="text-decoration: none;">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-primary border-primary border">
                        ...
                        <!--Start Vendors-->
                            <div class="col-md-6 col-xl-4">
                            <a href="his_admin_manage_vendor.php" style="text-decoration: none;">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-primary border-primary border">
                            ...
                            <div class="col-md-6 col-xl-4">
                            <a href="his_admin_equipments_inventory.php" style="text-decoration: none;">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-primary border-primary border">
                            ...
                            <!--Start Corporation Assets-->
                            <div class="col-md-6 col-xl-4">
                            <a href="his_admin_add_service.php" style="text-decoration: none;">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-primary border-primary border">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                ?>
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $assets;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate">Add Service</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                            ...
                            <div class="col-md-6 col-xl-4">
                            <a href="his_admin_view_pharmaceuticals.php" style="text-decoration: none;">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-primary border-primary border">
