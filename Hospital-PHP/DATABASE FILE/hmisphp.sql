...
--
-- Table structure for table `his_pharmacy`
--


CREATE TABLE `his_pharmacy` (
  `pharm_id` int(20) NOT NULL,
  `pharm_fname` varchar(200) DEFAULT NULL,
  `pharm_lname` varchar(200) DEFAULT NULL,
  `pharm_email` varchar(200) DEFAULT NULL,
  `pharm_pwd` varchar(200) DEFAULT NULL,
  `pharm_dept` varchar(200) DEFAULT NULL,
  `pharm_number` varchar(200) DEFAULT NULL,
  `pharm_dpic` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `his_pharmacy` (`pharm_id`, `pharm_fname`, `pharm_lname`, `pharm_email`, `pharm_pwd`, `pharm_dept`, `pharm_number`, `pharm_dpic`) VALUES
(111, 'Dawe', 'White', 'dawe@gmail.com', 'dce0b27ba675df41e9cc07af80ec59c475810824', 'Laboratory', 'dawe', 'defaultimg.jpg');
